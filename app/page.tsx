...
function buildEmail(name: string, company: string, email: string, message: string, logo: string, sabinLogo: string, factoryPhoto: string, visit: Visit) {
  ...
  <tr><td style="padding:18px 16px;border-bottom:1px solid #171714;font-size:0;line-height:0;"><a href="https://sabin.design/" target="_blank" rel="noopener noreferrer" style="display:inline-block;text-decoration:none;"><img src="${sabinLogo}" height="24" alt="Sabin" style="display:block;height:24px;width:auto;max-width:100%;border:0;"></a></td></tr>
